...
public class VueMedicament extends VueAbstraite
{
    ...
    private void initComponents() {
        ...
        txtEffets.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtEffetsActionPerformed(evt);
            }
        });

        txtContreIndic.setName("chCoef"); // NOI18N
        txtContreIndic.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtContreIndicActionPerformed(evt);
            }
        });
    ...
    private void txtEffetsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEffetsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtEffetsActionPerformed

    private void txtContreIndicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtContreIndicActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtContreIndicActionPerformed
