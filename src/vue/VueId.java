                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnQuitter, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
                            .addComponent(btnValider, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
    ...
    private void btnValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValiderActionPerformed
        try 
        {
            if (((CtrlId)controleur).menuAccueil()!= null) 
            {
                ...
                int rep = JOptionPane.showConfirmDialog(VueId.this, "Vous Êtes connecté(e) !", "GSB", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
            }
            else
            {
